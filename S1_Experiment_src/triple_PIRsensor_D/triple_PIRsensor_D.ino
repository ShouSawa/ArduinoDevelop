...
void setup() {
  ...
  Serial.write("Starting Aduino No.D\r\n"); // \r\nは改行
...
void loop() {
  ...
  // 取得したデータを送信
  Serial.println("circuit No.10 : " + String(buf1) + " , " + String(voltA0, 7) + "[V]");
  Serial.println("circuit No.11 : " + String(buf2) + " , " + String(voltA1, 7) + "[V]");
  Serial.println("circuit No.12 : " + String(buf3) + " , " + String(voltA2, 7) + "[V]");
