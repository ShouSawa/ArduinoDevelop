...
void setup() {
  ...
  Serial.write("Starting Aduino No.B\r\n"); // \r\nは改行
...
void loop() {
  ...
  // 取得したデータを送信
  Serial.println("circuit No.4 : " + String(buf1) + " , " + String(voltA0, 7) + "[V]");
  Serial.println("circuit No.5 : " + String(buf2) + " , " + String(voltA1, 7) + "[V]");
  Serial.println("circuit No.6 : " + String(buf3) + " , " + String(voltA2, 7) + "[V]");
